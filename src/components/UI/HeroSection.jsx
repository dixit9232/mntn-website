          ...
          <div className="container mx-auto py-4 md:py-6 px-4">
            ...
            {mobileMenuOpen && (
              <motion.div
                ...
                className="md:hidden fixed top-16 left-0 right-0 bg-[#0b1d266c] bg-opacity-40 backdrop-blur-md backdrop-filter z-50 p-6 shadow-lg transition-all border-t border-white border-opacity-10"
              >
                <nav className="mb-6">
